...
import com.windmill.rentalservice.config.auth.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        // Users have write access to the following.
                        .requestMatchers(HttpMethod.POST, "/api/v1/customers").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/customers").hasRole("USER")
